    ...
    bd.innerHTML = `
      <div class="ge-box">
        ...
        <div class="ge-body">
          ...
          <div class="ge-lbl">Your Score Row (paste into README.md)</div>
          ...
          <div class="ge-note" id="ge-pr-note">${owner ? '' : '⚠ PR button requires hosting on GitHub Pages — URL not detected.'}</div>
        </div>
      </div>`;
